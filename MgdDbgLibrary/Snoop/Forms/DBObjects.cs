...
namespace MgdDbg.Snoop.Forms
{
	...
	public class DBObjects : System.Windows.Forms.Form
	{
		...
		InitializeComponent()
		{
            ...
            // m_cntxMenuObjId
            // 
            this.m_cntxMenuObjId.Items.AddRange(new System.Windows.Forms.ToolStripMenuItem[] {
            this.m_mnuItemCopy,
            ...
            this.m_cntxMenuObjId.Opened += new System.EventHandler(this.OnContextMenuPopup);
            // 
            // m_mnuItemCopy
            // 
